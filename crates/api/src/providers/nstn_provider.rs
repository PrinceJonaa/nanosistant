...
fn resolve_saved_oauth_token_set(
    ...
    save_oauth_credentials(&nstn_runtime::OAuthTokenSet {
...
impl Provider for NstnApiClient {
...
mod tests {
    ...
    use nstn_runtime::{clear_oauth_credentials, save_oauth_credentials, OAuthConfig};

    use super::{
        now_unix_timestamp, oauth_token_is_expired, resolve_saved_oauth_token,
        resolve_startup_auth_source, AuthSource, NstnApiClient, OAuthTokenSet,
    };
    ...
    fn auth_source_from_saved_oauth_when_env_absent() {
        ...
        std::env::set_var("NSTN_CONFIG_HOME", &config_home);
        std::env::remove_var("ANTHROPIC_AUTH_TOKEN");
        std::env::remove_var("ANTHROPIC_API_KEY");
        save_oauth_credentials(&nstn_runtime::OAuthTokenSet {
    ...
    fn resolve_saved_oauth_token_refreshes_expired_credentials() {
        ...
        let stored = nstn_runtime::load_oauth_credentials()
    ...
    fn backoff_doubles_until_maximum() {
        let client = NstnApiClient::new("test-key").with_retry_policy(
            3,
