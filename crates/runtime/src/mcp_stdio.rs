...
use crate::mcp_config::{McpTransport, ScopedMcpServerConfig};
...
mod tests {
    ...
    use crate::mcp_config::{
        McpRemoteServerConfig, McpSdkServerConfig, McpServerConfig,
    ...
    fn rejects_non_stdio_bootstrap() {
        let config = ScopedMcpServerConfig {
            scope: ConfigSource::Local,
            config: McpServerConfig::Sdk(crate::mcp_config::McpSdkServerConfig {
